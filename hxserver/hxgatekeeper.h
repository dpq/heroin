...
namespace HxGateKeeperStatic {
    /* Officially unassigned by IANA this port is. Somewhen, it register even we may. */
...
public:
    ...
    void createGame(const GameOptions &options);
    void joinGame();
